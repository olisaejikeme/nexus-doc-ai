  ...
  return (
    <div className="max-w-[1400px] mx-auto p-8 lg:p-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        {/* Upload Area */}
        <label
          className={`lg:col-span-2 border-2 border-dashed rounded-2xl p-10 flex flex-col items-center justify-center bg-white dark:bg-slate-900/50 transition-all cursor-pointer 
        ...
        >
          <input
            ...
            accept=".pdf,.docx"
          />
          <div className="w-14 h-14 bg-blue-50 dark:bg-blue-900/20 rounded-xl flex items-center justify-center mb-4 transition-colors">
            <svg
        ...
        <div className="space-y-4">
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 p-6 rounded-2xl transition-colors hover:border-slate-300 dark:hover:border-slate-600">
                  ...
                  >
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="font-medium text-slate-900 dark:text-slate-200 truncate max-w-md">
                          {doc.name}
                        </span>
                      </div>
                    </td>
